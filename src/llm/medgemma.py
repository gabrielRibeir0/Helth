...
#                     bnb_4bit_use_double_quant=True, # Melhora precisão em modelos menores
...
#                 self.model_name,
#                 trust_remote_code=True # Necessário para modelos personalizados como MedGemma para carregar corretamente os tokenizers específicos do modelo
#             )
...
#                 trust_remote_code=True, # Necessário para modelos personalizados como MedGemma para carregar corretamente os modelos específicos do modelo
...
#             "do_sample": kwargs.get("do_sample", True), # Habilitar amostragem para respostas mais variadas
#             "top_p": kwargs.get("top_p", 0.9), # Nucleus sampling para controlar diversidade
#             "top_k": kwargs.get("top_k", 50), # Top-k sampling para controlar diversidade
#             "pad_token_id": self.tokenizer.eos_token_id, # Garantir que o modelo saiba quando parar
#         }
...
#         except ImportError:
#             raise ImportError("Instalar: pip install langchain-community")
...
#         except ImportError:
#             raise ImportError("Instalar: pip install langchain-google-vertexai")
...
#     else:
#         raise ValueError(f"Provider desconhecido: {provider}. Use 'huggingface', 'ollama', ou 'vertexai'")
